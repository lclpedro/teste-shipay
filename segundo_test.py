...
'''
Primera coisa a ser trabalhada é padronizar os projetos de acordo com a PEP-8,
assim o código ficará mais legível.

Imports seguir a ordem da PEP-8

Separar o projeto em pequenos pacotes, como a instanciação do flask, ter um
create_app() responsável por isso.

Criar um arquivo de configuração para armazenas as variáveis de ambientes e
controlar os ambientes que estão sendo executados. Como a declaração do postgres
que está acontecendo diretamente no código, com senha e usuário abertos.

User o ORM do sqlalchemy para fazer as querys
